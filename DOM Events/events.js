...
function renderTasks(tasks) {
  ...
  // loop through the tasks array. for each of 
    ...
    // const listElement = document.getElementsByClassName("todos");
    const listElement = document.getElementsById("#todoList");
    listElement.innerHTML = ""; 
    // Joe is dope - Jan 20 2023
    tasks.foreach();
    // why are they both tasks?
}
